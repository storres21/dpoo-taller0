...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este m�todo ejecuta la opci�n de buscar el pais al cual cierto atleta representa
	 */
	private void ejecutarPaisAtleta()
	{
		...
		if(pais == null)
			System.out.println("No se encontr� un atleta con el nombre ingresado ");
		else
		{
			System.out.println("El pais al cual representa " + nombreAtleta + " es: " + pais);
		}
	}
